  ...
  Widget build(BuildContext context) {
    return Theme(
      ...
      child: Scaffold(
        ...
        body: AppTheme.moodBackgroundContainer(
          primaryColor: widget.selectedMood.primaryColor,
          darkColor: widget.selectedMood.darkColor,
          child: SafeArea(
            child: Column(
              children: [
                SizedBox(height: 8.h),
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      SizedBox(height: 12.h),
                                      Text(
                                        widget.selectedMood.quotes[quoteIndex],
                                        style: TextStyle(
                                          color: AppTheme.whiteText,
                                          height: 1.6,
                                          fontSize: 14.sp,
                      ...
                      Container(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: widget.selectedMood.primaryColor
                                .withOpacity(0.9),
